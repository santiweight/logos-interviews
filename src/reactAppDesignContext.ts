...
- Implement styling inline or with local style objects because ReactApp code runs inside the Logos browser runtime. Do not import shadcn/ui, Tailwind, CSS files, icon packages, or external fonts unless the worksheet explicitly provides that dependency.
