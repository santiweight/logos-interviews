...
const statusOverrides = new Map<string, Pick<MigrationCase, "status" | "note">>([
  ...
  keyed("codeSheet.test.ts", "can start independent completions in parallel", "todo", "Important TS gap: parallel compilation is not restored for Logos-TS."),
  keyed("codeSheet.test.ts", "streams tokens from parallel completions before all snippets finish", "todo", "Important TS gap: parallel streaming is not restored for Logos-TS."),
  keyed("codeSheet.test.ts", "emits cache hits without invoking the LLM", "todo", "Important TS gap: cache-hit behavior should be tested without seeded dev cache."),
  ...
  keyed("codeSheet.test.ts", "models readiness through incomplete definitions and dependencies", "todo", "Important TS gap: run/play readiness is known incomplete."),
  ...
  keyed("codeSheet.test.ts", "passes parallel strategy through the runner", "todo", "Important TS gap: runner strategy passthrough is not covered."),
